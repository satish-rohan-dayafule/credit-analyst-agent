...
├── Credit_AI_Agent_Code.ipynb       # Main notebook: agent configs, tools & orchestration
├── data/                            # Input PDF financial statements (sample Tesla 2024 10-K)
└── extracted_financial_data.json    # Intermediate file storing extracted financial numbers
```
...
4. Ensure `PDF_FILE_PATH` points to the target financial statement inside the data folder (e.g., `"data/tsla-20241231.pdf"`).
